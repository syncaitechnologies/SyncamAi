...
| Zones, loitering and event-only vehicle/object logic | T-0307–T-0308, T-0330–T-0339, T-0416–T-0417 | `zones`, `configdelivery`, post-mask frame sampler and bounded FFmpeg handoff, Python track/zone/vehicle/abandoned-object modules | Deterministic unit and FFmpeg-to-mask-to-sampler integration tests | Library frame input is bounded after masking; executable remains on its null sink and no detector/model is promoted | PARTIAL | Add approved inference, executable composition, end-to-end integration and held-out evaluation |
