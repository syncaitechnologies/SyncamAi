...
| Zones, loitering and event-only vehicle/object logic | T-0307–T-0308, T-0330–T-0339, T-0416–T-0418 | `zones`, `configdelivery`, post-mask frame sampler, bounded FFmpeg handoff, deterministic detection association, Python track/zone/vehicle/abandoned-object modules | Deterministic unit, FFmpeg-to-mask-to-sampler, and synthetic detection-to-intrusion integration tests | Masked library frames and identity-free local association are bounded; executable remains on its null sink and no detector/model is promoted | PARTIAL | Add approved detector inference, production tracking evaluation, executable composition and held-out end-to-end evidence |
